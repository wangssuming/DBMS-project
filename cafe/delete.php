...
<div class="w3-container" id="CANCEL" style="padding-bottom:32px;">
  <div class="w3-content" style="max-width:700px">
    <h5 class="w3-center w3-padding-48"><span class="w3-tag w3-wide">CANCEL</span></h5>   
    <p><strong>Enter the order ID and Email to cancel:</strong> </p>
